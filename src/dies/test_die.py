...
class TestDieClass(unittest.TestCase):
	...
	def test_basic_setup(self):
		"""Test initial values"""
		self.assertEqual(self.d1k20.amount, 1)
		self.assertEqual(self.d1k20.sides, 20)
	...
	def test_roll_method_min_max_single_die(self):
		...
		rolls = [self.d1k20.roll() for i in range(1, 100)]
		self.assertGreaterEqual(self.d1k20.sides * self.d1k20.amount, min(rolls))
		self.assertLessEqual(self.d1k20.sides * self.d1k20.amount, max(rolls))
